...
from user.schemas.user_schema import CreateUserRequest, GetUserRequest, UserResponse, UpdateUserRequest
...
async def update_user(data: UpdateUserRequest, db: AsyncGenerator = Depends(get_db), payload: TokenPayload = Depends(auth.token_required(type="access", locations=["headers"]))):
